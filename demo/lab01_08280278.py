...
# add student details
name=input("Enter name of the student: ") #Enter the student name
age=input("Enter age: ") #Enter the age of the student
grade=input("Enter grade: ") #Enter the grade of the student

#check in if student exits and add the student name
if name in student_data: #Checking if the name of the student exists
...
search=input("Enter name of the student to search: ") #Enter name of the student to search
...
if search in student_data:
    ...
    print("Student not found.") #Print "Student not found." if student is not found
